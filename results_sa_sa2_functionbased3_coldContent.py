...
nsnow0326 = pd.DataFrame(readSpecificDatafromAllHRUs(nsnow,Apareto_model_param[0],4236)).T; nsnow0326.columns = Apareto_model_param[0]
...
sumlayer0326 = pd.DataFrame(sumBeforeSpecificDatafromAllHRUs(nlayer,Apareto_model_param[0],4236)).T; sumlayer0326.columns = Apareto_model_param[0]
