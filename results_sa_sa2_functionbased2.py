...
out_names = ["lj1110","lj1120","lj1130","lj1210","lj1220","lj1230","lj1310","lj1320","lj1330","lj2110","lj2120","lj2130","lj2210","lj2220","lj2230","lj2310","lj2320","lj2330",
             ...
             "mc1311","mc1312","mc1313","mc1321","mc1322",
...
#Apareto_model_param = pd.DataFrame(criteria_df.index[((criteria_df['maxSWE']) <= 130) & ((criteria_df['meltingRate'])<=0.25) & ((criteria_df['coldContent'])<=7)].tolist())
##%%
#fig = plt.figure(figsize=(20,15))
#xs = realMaxSWE_date[1:]
#ys = coldcontent0305
#plt.scatter(xs, ys)
#plt.xlabel('maxSWE date',fontsize=20)
#plt.ylabel('max cold content 305 (Mj/m2)',fontsize=20)
#plt.savefig('SA2/'+'maxsweDate_cc_0305')
#
##xs = coldcontent0305
##ys = coldcontent0509
##plt.scatter(xs, ys)
